...
export default function OrganizeFormAU({ show, uid, game_id, _title = "", _description = "", _location = "", _date = new Date(), _time = formatTimeToString(new Date()), _playerLevel = 0, _passcode = "", _maxPlayers = 22, _minPlayers = 1, _customRules = "", _requirements = "", editing = false, posted, onClose, onCancelled }: props) {
...
export function OrganizeFormJP({ show, uid, game_id, _title = "", _description = "", _location = "", _date = new Date(), _time = formatTimeToString(new Date()), _playerLevel = 0, _passcode = "", _maxPlayers = 22, _minPlayers = 1, _customRules = "", _requirements = "", editing = false, posted, onClose, onCancelled }: props) {
    const styles = useStyles()
    const [title, setTitle] = useState(_title)
    const [description, setDescription] = useState(_description)
    const [location, setLocation] = useState(_location)
